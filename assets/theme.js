...
theme.Video = (function() {
  ...
  function privatePlayVideo(id, clicked) {
    ...
    if (!autoplayCheckComplete) {
      autoplayCheckFunction(player, $videoWrapper);
    }
  }
  ...
  function autoplayCheckFunction(player, $videoWrapper) {
...
theme.customerTemplates = (function() {
  ...
  function initEventListeners() {
   ...
   // Hide reset password form
    ...
    $('#HideRecoverPasswordLinks').on(
      'click',
      function(evt) {
        evt.preventDefault();
        hideRecoverPasswordForms();
        this.$LoginHeading.attr('tabindex', '-1').focus();
      }.bind(this)
    );
  ...
  function showRecoverPasswordForms() {
    $('#RecoverPasswordForms').removeClass('hide');
    $('#CustomerLoginForms').addClass('hide');
  ...
  function hideRecoverPasswordForms() {
    $('#RecoverPasswordForms').addClass('hide');
    $('#CustomerLoginForms').removeClass('hide');
  }
    ...
    _updateAddToCart: function(evt) {
      ...
      if (variant) {
        if (variant.available) {
          ...
          $("#esc-oos-form_section").addClass('hide');
        } else {
          ...
          $("#esc-oos-form_section").removeClass('hide');
        }
      } else {
        $(this.selectors.addToCart, this.$container).prop('disabled', true);
        $(this.selectors.addToCartText, this.$container).text(
...
$(".site-header__cart").click(function() {
  ...
  $("#PageContainer").toggleClass('slideleft_body');
  $(".site-header").toggleClass('slideleft_header');
  $(".top_msg").toggleClass("slideleft_msg");
  $(".white_trans").fadeToggle('fast');
   $("body").toggleClass('no_scroll');
  
  $(".active-login").removeClass("active-login");
    $(".account-login").removeClass("text_underline");
    $("body").removeClass('no_scroll_login');	
    $(".login_overlay").fadeOut();
    $(".site-header").removeClass("open-login");
  ...
  $("#cls_icon, .black_trap").click(function() {
...
//console.log(parseFloat(get_rating_in_num).toFixed(1));

  
$(".spr-badge-caption").text(parseFloat(get_rating_in_num).toFixed(1));
...
//console.log(parseFloat(get_rating_in_num).toFixed(1));
  ...
  $(".spr-summary-actions-togglereviews i").text(parseFloat(get_rating_in_num).toFixed(1));
$(".spr-summary-actions-togglereviews i").css("opacity","1");
}, 5000);
  
//$('.bold_ro_frequency_type_text').remove(':contains("<br />")'); 
  
  $(".bold_ro_frequency_type_text").text(function () {
    return $(this).text().replace("<br />", ""); 
});

   
setTimeout(function(){  
  $(".free_msg").addClass('active');
 }, 4000); 
  
$(".cls_free").click(function() {  
  $(".free_msg").removeClass('active');
}); 
...
$(window).on('load resize', function () {
 topheight = $('.announcement-bar').height(); 
  $('#navigation, #added-box-wrapper').css('top', topheight);
});
...
$(document).ready(function(){
  ...
  $(".foot_my__account a").click(function(){
  //  alert("123");
  ...
  $(".account-login").click(function(){
    ...
    $(this).addClass("text_underline");
    $(".login-sidebar").toggleClass("active-login");
    $("body").toggleClass('no_scroll_login');	
    ...
    $(".site-header").toggleClass("open-login");
  ...
  $(".login_overlay, .close_slide").click(function(){
    $(".active-login").removeClass("active-login");
    $(".account-login").removeClass("text_underline");
    $("body").removeClass('no_scroll_login');	
    $(".login_overlay").fadeOut();
  ...
  $(".create_account_link").click(function(){
    ...
    $(".customer.login").hide();
    $(".login-n-title").hide();
    $(".account-n-title").show();
  });
  
  $(".create_login_link").click(function(){
    $(".customer.register").hide();
    $(".customer.login").show();
    $(".login-n-title").show();
    $(".account-n-title").hide();
  });
  
 
  
  $(".forget_pass").click(function(){
    $(".login_form").addClass("hide_form");
  });
  
  $(".cancle_form .cancel_btn a").click(function(){
    $(".login_form").removeClass("hide_form");
  });
